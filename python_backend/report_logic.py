...
def _fetch_single_day(day: date, shop_tz: str) -> Dict[str, Any]:
    ...
    try:
        ...
        result = {
            ...
            "shop_pur": kpis.shop_pur,
            "shop_spend": kpis.shop_spend,
            "google_cpa": kpis.google_cpa or 0.0,
            "meta_cpa": kpis.meta_cpa or 0.0,
            "shop_cpa": kpis.shop_cpa or 0.0,
            "general_cpa": kpis.general_cpa or 0.0,
            "psp_usd": kpis.psp_usd,
            "shipping_estimated": kpis.shipping_estimated,
            # Frontend reads `operational` / `margin`; keep the legacy keys too.
