...
pip install --quiet --constraint ../consolidation/requirements-dashboard-production.txt sqlalchemy[asyncio] asyncpg psycopg2-binary PyJWT httpx openai 2>/dev/null || true
