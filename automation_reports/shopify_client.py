...
SHOPIFY_API_VERSION = (os.getenv("SHOPIFY_API_VERSION") or "2025-01").strip() or "2025-01"
...
# IMPORTANT: Shopify 2025-01 does NOT have customerJourneySummary.{firstVisit,lastVisit}.landingPageUrl
ORDERS_GQL = """
